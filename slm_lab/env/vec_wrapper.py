# From OpenAI & pytorch-a2c-ppo-acktr-gail CITE TODO
"""
An interface for asynchronous vectorized environments.
"""
# TODO seeding in env init
# TODO frame_stack_size from spec
...
def env_fn(env_name, seed):
    def wrap_fn():
        return make_env(env_name, seed)
    return wrap_fn


def make_venv(env_name, seed=0, num_processes=4):
    venv = [
        env_fn(env_name, seed + i)
