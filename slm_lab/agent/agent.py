...
class Agent:
    ...
    def __init__(self, spec, env, global_nets=None, agent_index=0):
        ...
        self.agent_number = agent_index
        # set components
        body = Body(env, spec, aeb=(agent_index, 0, 0))
        body.agent = self
        self.body = body
...
class Body:
    ...
    def __init__(self, env, spec, aeb=(0, 0, 0)):
        ...
        # TODO remove state_dim, only use observable_dim
        self.state_dim = self.observable_dim
        logger.info("self.observable_dim {}".format(self.observable_dim))
    ...
    def get_log_prefix(self):
        ...
        prefix = f'Trial {trial_index} session {session_index} {spec_name}'
        if self.aeb != (0,0,0):
            prefix = prefix + f'_aeb{self.aeb}'
        return prefix
    ...
    def log_tensorboard(self):
        ...
        if not hasattr(self, 'tb_writer'):
            ...
            if self.aeb != (0, 0, 0):
                ...
                # TODO problem => currently overwritte other body tensorboard logs ?
