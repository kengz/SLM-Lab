...
class SoftActorCritic(ActorCritic):
    ...
    def init_nets(self, global_nets=None):
        '''
        Networks: net(actor/policy), critic (value), critic_tar, q_net, q_net_2
        ...
        self.q_net = NetClass(self.net_spec, q_in_dim, val_out_dim)
        self.q2_net = NetClass(self.net_spec, q_in_dim, val_out_dim)
        self.net_names += ['q_net', 'q2_net']
        ...
        self.q_optim = net_util.get_optim(self.q_net, self.q_net.optim_spec)
        self.q_lr_scheduler = net_util.get_lr_scheduler(self.q_optim, self.q_net.lr_scheduler_spec)
