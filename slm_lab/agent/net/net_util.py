...
def init_global_nets(algorithm):
    ...
    GPU Support: Global nets are kept on CPU for share_memory_() across processes.
    Worker local nets can run on GPU - gradients/params are transferred during sync.
    '''
