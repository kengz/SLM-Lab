...
python3 run_lab.py slm_lab/spec/experimental/le/ipd_study_hyperparam_stability.json ipd_study_hyperparams_nopm_le_vs_naive_opp_mod_lr_008 train
python3 run_lab.py slm_lab/spec/experimental/le/ipd_study_hyperparam_stability.json ipd_study_hyperparams_nopm_le_vs_naive_opp_mod_lr_002 train
python3 run_lab.py slm_lab/spec/experimental/le/ipd_study_hyperparam_stability.json ipd_study_hyperparams_nopm_le_vs_naive_opp_mod_lr_004 train
python3 run_lab.py slm_lab/spec/experimental/le/ipd_study_hyperparam_stability.json ipd_study_hyperparams_nopm_le_vs_naive_opp_mod_lr_016 train
python3 run_lab.py slm_lab/spec/experimental/le/ipd_study_hyperparam_stability.json ipd_study_hyperparams_nopm_le_vs_naive_opp_mod_lr_032 train
